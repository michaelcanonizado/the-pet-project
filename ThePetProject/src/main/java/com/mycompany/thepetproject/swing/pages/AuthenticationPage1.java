...
public class AuthenticationPage1 extends javax.swing.JFrame {

    /**
     * Creates new form AuthPage
     */
    public AuthenticationPage1() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AuthenticationPage1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AuthenticationPage1().setVisible(true);
            }
        });
    }
